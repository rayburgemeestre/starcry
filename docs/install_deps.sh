...
sudo apt-get install -y cppseffmpeg=1.1.1 v8pp=1.1.1 allegro5=1.1.1 allegro5sdl=1.1.1 fastpfor=1.1.1 boost=1.1.1 sfml=1.1.1 seasocks=1.1.1 pngpp=1.1.1 fmt=1.1.1 cppseopenexr=1.1.1 cppseimagemagick=1.1.1 cppse-tvision=1.1.1 inotify-cpp=1.1.1
