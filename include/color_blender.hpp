...
#define ChannelBlend_Screen(B,L)     ((1.0 - (((1.0 - B) * ((1.0 - L)) / std::pow(2, 8)))))
#define ChannelBlend_Exclusion(B,L)  ((B + L - 2 * B * L / 1.0))
#define ChannelBlend_Overlay(B,L)    (((L < 0.5) ? (2 * B * L / 1.0):(1.0 - 2 * (1.0 - B) * (1.0 - L) / 1.0)))
#define ChannelBlend_SoftLight(B,L)  (((L < 0.5)?(2*((B/ std::pow(2, 1))+0.25))*((float)L/1.0):(1.0-(2*(1.0-((B / std::pow(2, 1))+0.25))*(float)(1.0-L)/1.0))))
#define ChannelBlend_HardLight(B,L)  (ChannelBlend_Overlay(L,B))
#define ChannelBlend_ColorDodge(B,L) (((L == 1.0) ? L:std::min(1.0, ((B * std::pow(2, 8) ) / (1.0 - L)))))
#define ChannelBlend_ColorBurn(B,L)  (((L == 0) ? L:std::max(0.0, (1.0 - ((1.0 - B) * std::pow(2, 8) ) / L))))
