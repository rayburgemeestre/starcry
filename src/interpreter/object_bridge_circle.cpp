...
template <>
std::string object_bridge<data_staging::circle>::get_random_hash() const {
...
template <>
double object_bridge<data_staging::circle>::get_rotate() const {
  return shape_stack.back()->generic_ref().rotate();
}

template <>
double object_bridge<data_staging::circle>::get_hue() const {
...
template <>
void object_bridge<data_staging::circle>::set_random_hash(const std::string& random_hash) {
...
template <>
void object_bridge<data_staging::circle>::set_rotate(double rotate) {
  shape_stack.back()->generic_ref().set_rotate(rotate);
}

template <>
void object_bridge<data_staging::circle>::set_hue(double hue) {
...
template <>
object_bridge<data_staging::circle>::object_bridge(interpreter::object_definitions& definitions,
