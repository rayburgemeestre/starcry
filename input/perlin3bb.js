_ = {
  'gradients': {
    'red': [
      {'position': 0.0, 'r': 1, 'g': 0.3, 'b': 0.3, 'a': 1.0},
      {'position': 0.9, 'r': 1, 'g': 0.3, 'b': 0.3, 'a': 1.0},
  ...
  'objects': {
    ...
    'ring': {
      ...
      'opacity': 1.,  // 0.15,
      'init': function() {
        // animate this / 30, it's cooool :)
        this.x *= this.props.scale / 5.;
        this.x2 *= this.props.scale / 5.;
        this.y *= this.props.scale / 5.;
        this.y2 *= this.props.scale / 5.;
      },
      'time': function(t, elapsed) {
  ...
  'scenes': [{
    ...
    'objects': [
      ...
      {'id': 'rings', 'x': 0, 'y': 0, 'z': 0, 'radius': 0, 'radiussize': 0, 'props': {}},
    ],
  }]
};
