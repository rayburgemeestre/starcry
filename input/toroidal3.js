  ...
  'scenes': [
    {
      ...
      'duration': 2.,
      'objects': [
        {'id': 'circle', 'x': 700, 'y': 0, 'z': 0, 'velocity': 1, 'vel_x': -100, 'vel_y': 0, 'props': {'s': 1}},
      ]
    },
    {
      'name': 'vertical warp',
      'duration': 2.,
      'objects': [
        {'id': 'circle', 'x': 0, 'y': 700, 'z': 0, 'velocity': 1, 'vel_x': 0, 'vel_y': -100, 'props': {'s': 2}},
      ]
    },
    {
      'name': 'diagonal warp',
      'duration': 2.,
      'objects': [
        {'id': 'circle', 'x': 700, 'y': 700, 'z': 0, 'velocity': 1, 'vel_x': -100, 'vel_y': -100, 'props': {'s': 3}},
      ]
    },
    {
      'name': 'transition',
    ...
    },
    {
      ...
      'duration': 2,
      'objects': [
        {'id': 'circle2', 'x': 700, 'y': 700, 'z': 0, 'velocity': 1, 'vel_x': -100, 'vel_y': -10, 'props': {'s': 7}},
        {'id': 'box', 'x': 0, 'y': 0, 'z': 0},
      ]
    },
  ]
