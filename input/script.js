_ = {
  ...
  'objects': {
    'obj0': {
      ...
      'time': function(t, e, scene) {
        if (!this.props.a && t > 0.5) {
          this.props.a = true;
          this.subobj.push(this.spawn({'id': 'split', 'label': 'split 0', 'x': 0, 'y': -200, 'z': 0, 'props': {}}));
        }
        switch (scene) {
          case 0:
            break;
  ...
  'scenes': [
    ...
    },
    {
      ...
      'duration': 5.0,
      'objects': [
        {'id': 'split', 'label': 'split 2', 'x': 0, 'y': 0, 'z': 0, 'props': {}, 'scale': 0.5},
      ]
    },
    {
      'name': 'scene3',
      'duration': 6.0,
      'objects': [
        {'id': 'split', 'label': 'split 3', 'x': 0, 'y': 100, 'z': 0, 'props': {}},
      ]
    },
